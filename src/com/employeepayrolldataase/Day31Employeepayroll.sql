...
insert into employee_payroll(name,salary,start) VALUES ('Bill',1000000.00,'2018-01-03'), ('Teresa',2000000.00,'2019-11-13'), ('Charlie',3000000.00,'2020-05-21');
select * from employee_payroll;
select salary from employee_pay where start between cast('2018-01-01' as date) and date(now());
select * from employee_payroll where salary > 30000;
select salary from employee_pay where start between cast('2019-01-01' as date) and date(now());
alter table employee_payroll add gender char(1) after name not null;
describe employee_payroll;
...
select * from employee_payroll;
insert into employee_payroll (name, gender, salary, start, Phone, Department, address, basicPay, Deductions, TaxablePay, IncomeTax, NetPAy) VALUES ('Teresa', 'F', 3000000.00, '2018-01-03', 985628, 'Marketing', 'Mumbai', 3000000.00, 1000000.00, 2000000.00, 500000.00, 15000000.00);
select * from employee_payroll;
...
update employee_payroll set Phone = '7775827779' where id = '3';
